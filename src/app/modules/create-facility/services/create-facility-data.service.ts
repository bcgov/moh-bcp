...
export class CreateFacilityDataService extends BaseDataService {
  ...
  <ol type='i'>
    <li>this is a legal document and I represent that the information that I have provided on this document is true to the best of my knowledge;</li>
    <li>MSP is a public system based on trust, but also that claims, including those portions relating to the Business Cost Premium, are subject to audit and financial recovery for claims made contrary to the Medicare Protection Act (the "Act");</li>
    <li>submitting false or misleading claims information is an offence under the Act and may be an offence under the Criminal Code of Canada;</li>
    ...
    <li>(a) any MSP Facility Number issued to this facility is specific to this facility and to the physical address of this facility; (b) the MSP Facility Number issued to this facility will be used to calculate the applicable Business Cost Premium on Eligible Fees payable to Eligible Physicians providing services at this facility;  and (c)  Physicians who do not meet the criteria to be Eligible Physicians or who are not entitled to bill Eligible Fees for this facility are not to be attached to the MSP Facility Number assigned to this facility; and</li>
